...
class DetectionManager:
    ...
    def setupDetection(self, detection_period_id, neural_network_type, detection_seconds,
                       obj_threshold, box_overlap_threshold, camera_rotation, framerate, video_resolution):
...
class Detector:
    ...
    def detect(self, image):
        ...
        filtered_boxes_with_people = self.non_max_suppression_fast(np.array(boxes_with_people), self.box_overlap_threshold)
